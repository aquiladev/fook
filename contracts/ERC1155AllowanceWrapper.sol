...
contract AllowanceWrapper is IERC1155, IERC165
{
    ...
    */
    ...
    view
    returns (bool) {
         IERC165(address(targetContract)).supportsInterface(_interfaceId);
    }
